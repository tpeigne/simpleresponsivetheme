...
{if $hasProduct}
<p class="show-for-small">{l s='Scroll to see the full table.'}</p>
<div class="products_block table_scroll_small">
        ...
        {foreach from=$products item=product name=for_products}
            ...
            <td width="{$width}%" class="ajax_block_product comparison_infos">
                ...
                <div class="comparison_product_infos">
                    ...
                    <a class="cmp_remove" href="{$link->getPageLink('products-comparison', true)}" rel="ajax_id_product_{$product->id}" title="{l s='Remove'}">&nbsp</a>
