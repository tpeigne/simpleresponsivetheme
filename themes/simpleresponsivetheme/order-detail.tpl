    ...
    <table class="table_responsive std">
        ...
        <tfoot>
            {if $priceDisplay && $use_tax}
                <tr class="item">
                    ...
                    <td class="table-hide-small"></td>
                    <td>
                        {l s='Total products (tax excl.):'} {if $use_tax}{l s='(tax incl.)'}{/if}:
                    </td>
                    <td>
            ...
            <tr class="item">
                ...
                <td class="table-hide-small"></td>
                <td>
                    {l s='Total shipping'} {if $use_tax}{l s='(tax incl.)'}{/if}:
                </td>
                <td>
        ...
        {foreach from=$products item=product name=products}
            {if !isset($product.deleted)}
                ...
                {if isset($product.customizedDatas)}
                    <tr class="item">
                        {if $return_allowed}<td class="order_cb table-hide-small"></td>{/if}
                        <td class="table-hide-small"><label for="cb_{$product.id_order_detail|intval}">{if $product.product_reference}{$product.product_reference|escape:'htmlall':'UTF-8'}{else}--{/if}</label></td>
                        <td class="bold">
                ...
                {if $product.product_quantity > $product.customizationQuantityTotal}
                    <tr class="item">
                        {if $return_allowed}<td class="order_cb table-hide-small"><input type="checkbox" id="cb_{$product.id_order_detail|intval}" name="ids_order_detail[{$product.id_order_detail|intval}]" value="{$product.id_order_detail|intval}" /></td>{/if}
                        <td class="bold table-hide-small"><label for="cb_{$product.id_order_detail|intval}">{if $product.product_reference}{$product.product_reference|escape:'htmlall':'UTF-8'}{else}--{/if}</label></td>
                        <td>
                            <label for="cb_{$product.id_order_detail|intval}">
    ...
    <table class="std table_responsive">
        <thead>
            <tr>
                ...
                <th class="item table-hide-small">{l s='Weight'}</th>
                <th class="item table-hide-small">{l s='Shipping cost'}</th>
...
{if !$is_guest}
    ...
    <form action="{$link->getPageLink('order-detail', true)|escape:'html'}" method="post" class="std" id="sendOrderMessage">
        ...
        <p class="submit">
            ...
            <input type="submit" class="button radius" name="submitMessage" value="{l s='Send'}"/>
        </p>
    </form>
{else}
