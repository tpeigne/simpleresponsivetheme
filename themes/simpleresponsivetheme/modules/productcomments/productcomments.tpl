...
<div id="idTab5">
	...
	{else}
		...
		<p class="align_center">
			<a id="new_comment_tab_btn" class="open-comment-form">{l s='Be the first to write your review' mod='productcomments'} !</a>
		</p>
		{else}
	...
	<form action="#">
		...
		<fieldset class="new_comment_form_content">
			...
			<div id="new_comment_form_footer">
				...
				<p class="fr">
					<button id="submitNewMessage" class="button radius" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>&nbsp;
					{l s='or' mod='productcomments'}&nbsp;<a href="#" onclick="$('#new_comment_form').trigger('reveal:close');">{l s='Cancel' mod='productcomments'}</a>
				</p>
				<div class="clearfix"></div>
			</div>
		</fieldset>
