...
<form action="{$link->getPageLink('address', true)}" method="post" class="" id="add_adress">
    <fieldset>
        <div class="row">
            ...
            <div class="six columns">
                ...
                <p class="text">
                    ...
                    <input type="tel" id="phone" name="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{else}{if isset($address->phone)}{$address->phone|escape:'html'}{/if}{/if}" />
                </p>
                <p class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}text">
                    <label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                    <input type="tel" id="phone_mobile" name="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{else}{if isset($address->phone_mobile)}{$address->phone_mobile|escape:'html'}{/if}{/if}" />
                </p>
                ...
                <p class="submit2">
                    ...
                    <input type="submit" name="submitAddress" id="submitAddress" value="{l s='Save'}" class="button radius" />
                </p>
            </div>
        </div>
    </fieldset>
