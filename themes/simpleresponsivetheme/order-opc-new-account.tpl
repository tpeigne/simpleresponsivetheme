        ...
        <fieldset>
            <div id="opc_account_choice" class="row">
                <div class="six columns">
                    ...
                    <p>
                        <input type="button" class="exclusive_large button radius" id="opc_guestCheckout" value="{l s='Checkout as guest'}" />
                    </p>
                </div>
                ...
                <div class="six columns">
                    ...
                    <p>
                        <input type="button" class="button_large button radius" id="opc_createAccount" value="{l s='Create an account'}" />
                    </p>
                </div>
            </div>
