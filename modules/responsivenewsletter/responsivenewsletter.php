...
class ResponsiveNewsletter extends Module
{
    ...
    {
        $this->name = 'responsivenewsletter';
        $this->tab = 'front_office_features';
        $this->need_instance = 0;

        parent::__construct();

        $this->displayName = $this->l('Responsive newsletter block');
    ...
    {
        $verif_url = Context::getContext()->link->getModuleLink('responsivenewsletter', 'verification', array(
            'token' => $token,
        ));
    ...
    public function hookDisplayFooter($params)
    {
        ...
        return $this->display(__FILE__, 'responsivenewsletter.tpl');
    }
}
